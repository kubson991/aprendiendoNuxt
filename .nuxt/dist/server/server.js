...
/******/ 			var chunk = require("./" + ({"1":"pages/albums/_id","2":"pages/index"}[chunkId]||chunkId) + ".js");
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".container{transition:all .4s ease-in}.page-enter-active,.page-leave-active{transition:opacity .5s}.page-enter,.page-leave-active{opacity:0}header{margin-bottom:20px}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
const _14596ae9 = () => interopDefault(__webpack_require__.e(/* import() | pages/albums/_id */ 1).then(__webpack_require__.bind(null, 34)));

const _137ab330 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 2).then(__webpack_require__.bind(null, 33)));
